    ...
    <div className="min-h-screen flex items-center justify-center bg-base-200">
      <div className="card w-full max-w-sm md:max-w-lg shadow-lg bg-base-100 p-8">
        ...
        <form action={handleSubmit}>
          ...
          <div className="form-control mb-4">
            <label className="label">
              <span className="label-text text-base-content">Contact Number</span>
            </label>
            <input type="number" placeholder="Enter your contact number" className="input input-bordered" name="phone" required />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="form-control">
              ...
              <input type="password" placeholder="Confirm your password" className="input input-bordered" name="confirmpass" required />
            </div>
          </div>
